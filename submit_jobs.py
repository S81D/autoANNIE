...
def grid_BC(user, TA_tar_name, name_TA, input_path):
    ...
    file.write('${JSB_TMP}/ifdh.sh cp -D /srv/FilteredMRDData_${PART_NAME}_${PI}_${PF} $CONDOR_DIR_OUTPUT    # Filtered MRD Data\n')
    file.write('\n')
    file.write('echo "" >> ${DUMMY_OUTPUT_FILE}\n')
    file.write('echo "Input:" >> ${DUMMY_OUTPUT_FILE}\n')
    file.write('ls $CONDOR_DIR_INPUT >> ${DUMMY_OUTPUT_FILE}\n')
...
def container_BC(name_TA, input_path):
    ...
    file.write('\cp configfiles/BeamClusterAnalysis/my_input.txt configfiles/LAPPDProcessedFilter/.\n')
    ...
    file.write('cd ../../\n')
    file.write('echo "File present in filtered my_inputs.txt:" >> /srv/logfile_BC_Filtered_${PART_NAME}_${PI}_${PF}.txt\n')
    file.write('cat configfiles/BeamClusterAnalysis/my_inputs.txt >> /srv/logfile_BC_Filtered_${PART_NAME}_${PI}_${PF}.txt\n')
    ...
    file.write('cp FilteredMRDData /srv/\n')
    file.write('cp FilteredAllLAPPDData /srv/\n')
    file.write('\n')
    file.write('# make sure any output files you want to keep are put in /srv or any subdirectory of /srv\n')
    file.write('\n')
    file.write('### END ###\n')
